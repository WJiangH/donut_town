...
- The shop renders six items per shelf. Unplaced Home inventory uses lazy, asynchronously decoded thumbnails; only placed objects and an active drag need full art. The 14×9 floor bounds the number of placed objects.
