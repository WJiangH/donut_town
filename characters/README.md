...
Most custom-photo members now have a wardrobe-capable rig. Slot IDs stay `jacket` / `shoes` / `eyewear`. Default Slack avatars, non-human custom images, and unrigged character drafts stay on the shared or existing atlas.
