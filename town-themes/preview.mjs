...
try {
  ...
  for (const [id,e] of Object.entries(theme.entrances)) {
    const label=document.createElement('span');label.textContent=id==='chemPod'?'Chem Pod':'Shop';label.style.left=e.x+'%';label.style.top=e.y+'%';document.querySelector('#doors').append(label);
  }
